...
MACRO(LOAD_COMMON_UTILS)
    SET(COMMON_UTILS_HOME ${3RDPARTY_DIR}/common_utils)
    IF (TARGET_OS STREQUAL "Android")
        SET(CMAKE_FIND_ROOT_PATH ${CMAKE_FIND_ROOT_PATH} ${COMMON_UTILS_HOME}/lib/cmake)
    ELSE()
        LIST(APPEND CMAKE_PREFIX_PATH ${COMMON_UTILS_HOME}/lib/cmake)
    ENDIF()
    FIND_PACKAGE(common_utils)

    IF(NOT common_utils_FOUND)
        MESSAGE(FATAL_ERROR "common_utils not found!")
    ENDIF()
ENDMACRO()
